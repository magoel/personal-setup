...
syn keyword verilogStatement   always initial module endmodule or always always_comb always_ff 
syn keyword verilogStatement   task endtask void
...
syn keyword verilogStatement   integer real logic int shortint longint bit byte enum struct union  tagged
syn keyword verilogStatement   time packed signed unsigned typedef
...
syn keyword verilogRepeat      forever repeat while for do unique priority
